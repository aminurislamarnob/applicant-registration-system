                    ...
                    <div class="personal-info">
                        <div class="form-group-left">
                                    ...
                                    <fieldset id="like_to_travel" class="required">
                                        <ul>
                                            <li>
                                                ...
                                                <input type="radio" value="1" id="like_to_travel_1" name="like_to_travel" checked>
                                            </li>
                                            <li>
                            ...
                            <div class="form-group form-error">
                                ...
                                <input type="text" placeholder="<?php echo esc_attr__( 'Monthly income', 'applicant-registration-system' ); ?>" id="desired_monthly_income" name="desired_monthly_income" class="form-control required">
                            </div>
                        </div>
                    </div>
                    <div class="form-group-right">
                            ...
                            <fieldset id="willing_to_travel">
                                <ul>
                                    <li>
                                        ...
                                        <input type="radio" value="1km" id="1km" name="willing_to_travel" checked>
                                    </li>
                                    <li>
                        ...
                        <div class="form-group form-error button-option">
                            ...
                            <div class="maxmini-section">
                                <div>
                                    <input type="text" placeholder="<?php echo esc_html__( 'Minimum hours', 'applicant-registration-system' ); ?>" name="minimum_hours_per_week" id="minimum_hours_per_week">
                                </div>
                                <div class="line"></div>
                                <div>
                                    <input type="text" placeholder="<?php echo esc_html__( 'Maximum hours', 'applicant-registration-system' ); ?>" name="maximum_hours_per_week" id="maximum_hours_per_week">
                                </div>
                            </div>
                        </div>
                    </div>
